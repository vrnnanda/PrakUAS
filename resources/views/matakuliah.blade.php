                ...
                <div class="row">
                    <div class="col-lg-2 vh-100">
                        <div class="nav flex-column nav-pills mt-4" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link active" href="/matakuliah" aria-controls="/matakuliah" aria-selected="false">Matakuliah</a>
                        </div>
                    </div>
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $mk-> sks}}</td>
                                            <td>
                                                <a href="/matakuliah /editMhs/{{$mk -> id}}" class="btn btn-outline-success"><i class="bi bi-pencil-square"></i></a>
                                                <button onclick="delKonfirm({{$mk->id}})" class="btn btn-outline-danger"><i class="bi bi-x-square"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
