                    ...
                    <div class="col-lg-10 vh-100">
                        <div class="card mt-4">
                            <div class="card-header">
                                <a name="" class="btn btn-primary" href="/user/formuser" role="button"><i class="bi bi-plus-square-fill"></i> ADD USER</a>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button onclick="delKonfirm({{$u->id}})" class="btn btn-outline-danger"><i class="bi bi-x-square"></i></a>
                            </td>
                        </tr>
                            @endforeach
                        </tbody>
