                ...
                <div class="row">
                    <div class="col-lg-2 vh-100">
                        <div class="nav flex-column nav-pills mt-4" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link active" href="/dosen" aria-controls="/dosen" aria-selected="false">Dosen</a>
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $d -> nama}}</td>
                                            <td>
                                                <a href="/dosen/editMhs/{{$d -> id}}" class="btn btn-outline-success"><i class="bi bi-pencil-square"></i></a>
                                                <button onclick="delKonfirm({{$d->id}})" class="btn btn-outline-danger"><i class="bi bi-x-square"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
